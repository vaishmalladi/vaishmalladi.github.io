...
export default function RotatingAvatar({ className }: { className?: string }) {
  return (
    <div className={`relative flex items-center justify-center ${className ?? ""}`}>
      ...
      <div className="avatar-aura-glow pointer-events-none absolute left-1/2 top-1/2 aspect-square w-[108%] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-70" />
