...
export default function Polaroid({ item }: PolaroidProps) {
  return (
    <motion.div
      ...
      data-cursor="project"
      className="w-56 flex-none border border-[var(--color-hairline)]/15 bg-[var(--color-surface-2)] p-3 pb-5 shadow-[0_20px_45px_-16px_rgba(0,0,0,.75)]"
    >
      <div className="flex h-40 items-center justify-center border border-[var(--color-hairline)]/10 bg-[linear-gradient(145deg,var(--color-surface),var(--color-surface-2))] text-5xl">
        {item.emoji}
      </div>
